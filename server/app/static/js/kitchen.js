document.addEventListener("DOMContentLoaded", () => {
        ...
        (order) => `
            <div class="order-card ${order.status}">
                <div class="order-header">
                    <h3>Order #${order.id} <span class="table-number">(Table ${
          order.table
        })</span></h3>
                    <div class="order-meta">
                        ...
                        <span class="timer"><i class="fas fa-clock"></i> ${timeSince(
                          order.created_at
                        )}</span>
                    </div>
                </div>
                ...
                <div class="order-body">
                    ...
                    <div class="order-actions">
                        ...
                        <button class="btn cancel" onclick="handleAction(${
                          order.id
                        }, 'cancel')">
  ...
  const updateStats = () => {
    stats.pending.textContent = currentOrders.filter(
      (o) => o.status === "pending"
    ).length;
